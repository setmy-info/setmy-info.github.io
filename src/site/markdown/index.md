...
* [IT](empty.html)
    ...
    * Knowledge (NOTE: Can be as this, separate directory. Or also can be in the **root** directory. So **Knowledge**
      can be removed and content can be moved out from **IT** also. Everything is mostly about know how/howto.)
        ...
        * [material design icons](materialdicons.html)
        * [material symbols](material-symbols.html)
        * [MDI (Pictogrammers Material Design Icons)](mdi.html)
        * [MUI Material Icons](mui-icons.html)
        * [AWS (Amazon Web Services)](aws.html)
        * [DigitalOcean](digitalocean.html)
        * [Hetzner Cloud](hetzner-cloud.html)
        * [Scaleway](scaleway.html)
        ...
        * [Erlang](erlang.html)
        * [Java](java.html)
        * [LFE (Lisp Flavored Erlang)](lfe.html)
        * [Nerves Project](nerves.html)
        * [Common LISP](lisp.html)
        * [Python](python.html)
        ...
        * [NVIDIA Nemotron 3 Ultra](nemotron-3-ultra.html)
        ...
        * [Tauri](tauri.html)
        * [Twenty](twenty.html)
        * [Spotless](spotless.html)
        * [Monaco Editor](monaco-editor.html)
        * [CodeMirror](codemirror.html)
        * [Ace Editor](ace.html)
        * [Diff2Html](diff2html.html)
        * [AppLess](appless.html)
        * [OpenUI](openui.html)
        ...
        * [Fluent Bit](fluent-bit.html)
        * [Vector](vector.html)
        * [Angular](angular.html)
        * [Angular Start Project](angular-start-project.html)
