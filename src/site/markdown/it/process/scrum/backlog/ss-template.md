...
**As a** <system / service / actor>
**I want** <process / operation / behavior>
**So that** <system-level outcome / integration / automation>
...
* AC1: <Condition that must be met for the story to be considered done>
* AC2: ...
* AC3: ...
