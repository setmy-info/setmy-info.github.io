...
<!-- REVIEW: R-05 — IE11 is end-of-life since June 2022; this statement is outdated -->
...
<!-- REVIEW: R-04 — contradicts Angular (mandatory TypeScript) and adr-0030 (all examples in TypeScript); scope of this preference must be clarified -->
...
1. [ADR-0030 Framework-Agnostic Frontend Development with Thin UI](adr-0030-framework-agnostic-fe-development.md)
1. [ADR-0031 Top level testing groups](adr-0031-test-levels.md)
1. [ADR-0032 SMI FHS](adr-0032-smi-fhs.md)
1. [ADR-0033 Gintra as group intranet directory structure under setmy.info](adr-0033-gintra-group-intranet-directory-structure.md)
1. [ADR-0034 ZFS organization dataset layout for gintra](adr-0034-zfs-organization-dataset-layout.md)
1. [ADR-0035 NFS export per organization dataset path](adr-0035-nfs-export-per-organization-dataset.md)
1. [ADR-0036 Logical gintra path mapped to physical storage mount](adr-0036-logical-gintra-path-mapped-to-physical-storage-mount.md)
1. [ADR-0037 Gintra top-level typed subtrees](adr-0037-gintra-top-level-typed-subtrees.md)
1. [ADR-0038 AWS S3 bucket and key naming derived from gintra](adr-0038-aws-s3-bucket-and-key-naming-derived-from-gintra.md)
1. [ADR-0039 JWT claims for person and organization context](adr-0039-jwt-claims-for-person-and-organization-context.md)
1. [ADR-0040 MQTT topic name conventions](adr-0040-mqtt-topic-name-conventions.md)
...
1. [PWA vs. Native vs. Desktop Comparison](../../../pwa-comparison.md)
1. [CapacitorJS](../../../capacitorjs.md)
1. [npm](../../../npm.md)
1. [Android](../../../android.md)
1. [iOS](../../../ios.md)
1. [F-Droid](../../../fdroid.md)
1. [GitHub CI Tips](../../../ci-github.md)
1. [Self managed repos](shouldHaveSelfManagedRepos.md)
1. [Should have VCS hash](shouldHaveVCShash.md)
1. [Time aspect importance in software development](timeImportance.md)
