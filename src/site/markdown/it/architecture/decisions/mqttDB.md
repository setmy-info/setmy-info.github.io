...
<!-- REVIEW: R-01 — uses PostgreSQL (relational) for MQTT storage; contradicts ADR-0028 req.17 which mandates schemaless DB -->
<!-- REVIEW: R-02 — requirement list below (items 1-32) consists entirely of placeholder dots; no actual requirements written -->
1. ...
1. ...
1. ...
1. ...
