...
Livebook is a collaborative notebook for interactive Elixir and Erlang development. It allows you to write, run, and
share code in a web-based environment.
...
Text attributes _italic_ or *italic*, **bold**, `monospace`, ~~strikethrough~~.
